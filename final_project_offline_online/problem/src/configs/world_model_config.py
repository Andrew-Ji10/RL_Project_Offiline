...
def world_model_config(
    ...
    world_model_warmup_steps: int = 20000,
    synthetic_start_uncertainty_threshold: float = 0.3,
    synthetic_rollout_horizon: int = 1,
    synthetic_ratio: float = 0.25,
    initial_synthetic_ratio: float = 0.0,
    synthetic_ratio_ramp_rate: float = 0.0005,
